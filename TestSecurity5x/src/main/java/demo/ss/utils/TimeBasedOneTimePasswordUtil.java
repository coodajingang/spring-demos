...
public class TimeBasedOneTimePasswordUtil {
    ...
    public static String generateOtpAuthUrlOri(String keyId, String secret) {
        return generateOtpAuthUrlOri(keyId, secret, DEFAULT_OTP_LENGTH);
    }
    ...
    public static String generateOtpAuthUrlOri(String keyId, String secret, int numDigits) {
        StringBuilder sb = new StringBuilder(128);
        addOtpAuthPartOri(keyId, secret, sb, numDigits);
        return sb.toString();
    }
    ...
    private static void addOtpAuthPartOri(String keyId, String secret, StringBuilder sb, int numDigits) {
        sb.append("otpauth://totp/")
                .append(keyId)
                .append("?secret=")
                .append(secret)
