...
public class TwoFactorAuthExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String s = TimeBasedOneTimePasswordUtil.generateOtpAuthUrl(keyId, base32Secret);
        System.out.println(s);
        System.out.println(ZxingPngQrGenerator.generateBase64QRPng(s));
